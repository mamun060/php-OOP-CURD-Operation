                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    ...
                    <div class="list-group">
                        ...
                        <div class="list-group-item">
                            <input name="user_name" placeholder="Username" type="text" class="form-control no-border"> 
                        </div>
                        <div class="list-group-item">
                            <input name="admin_email" type="text" placeholder="Email" type="text" class="form-control no-border"> 
                        </div>
                        <div class="list-group-item">
                            <input name="admin_pass" type="password" placeholder="Password" type="password" class="form-control no-border"> 
                        </div>
                    </div>
